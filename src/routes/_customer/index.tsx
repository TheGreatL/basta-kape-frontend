                ...
                <div className="container mx-auto px-4 relative z-10 flex flex-col items-center text-center">
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center w-full sm:w-auto">
                        <Link to="/products">
                            <Button
                                size="lg"
                                className="w-full sm:w-auto gap-2 bg-amber-600 hover:bg-amber-700 text-white border-0 text-sm font-semibold h-12 px-8 shadow-lg shadow-amber-950/50 hover:-translate-y-0.5 transition-transform"
                            >
                                Order Now
                        ...
                        <Link to="/products">
                            <Button
                                size="lg"
                                variant="outline"
                                className="w-full sm:w-auto text-sm font-semibold h-12 px-8 text-amber-200 border-amber-500/30 hover:bg-amber-500/10 transition-colors"
                            >
                                Explore Menu
                            </Button>
                        </Link>
