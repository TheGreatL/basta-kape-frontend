    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            toast.success('Product Created', {
                description: 'The new product has been successfully added to catalog.'
            });
            onOpenChange(false);
        },
        onError: (error) => {
            ...
            <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col p-0 overflow-hidden bg-background">
                <DialogHeader className="px-6 pt-6 pb-2">
                    ...
                    <DialogDescription className="text-xs">
                        Configure the parent product identity profile and assign metadata settings.
                    </DialogDescription>
                </DialogHeader>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 flex flex-col min-h-0">
                        <div className="flex-1 overflow-y-auto px-6 py-2 space-y-4 min-h-0">
                            {isDataLoading ? (
                                <div className="flex flex-col items-center justify-center py-24 gap-3">
                                    ...
                                    <span className="text-xs text-muted-foreground font-medium">Loading form options...</span>
                                </div>
                            ) : (
                                <>
                                    {/* Photo Uploader */}
                        ...
                        <DialogFooter className="px-6 py-4 border-t bg-muted/30 mt-4">
                            ...
                            <Button type="submit" disabled={createMutation.isPending || isDataLoading} className="h-9">
