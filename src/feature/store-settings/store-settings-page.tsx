                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <Card className="shadow-xs border-border/60 bg-card/40">
                                <CardHeader className="border-b border-border/40 pb-4">
                                    ...
                                    <CardDescription className="text-xs">Set Value-Added Tax (VAT) rate and default service charges.</CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4 pt-4">
                                    <FormField
                                        control={form.control}
                                ...
                                <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            ...
                                            <AlertDialogDescription>
                                                Are you sure you want to reset all store settings configurations back to system defaults? This will
                                                erase custom store names, operating hours, and tax rates.
                                            </AlertDialogDescription>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
