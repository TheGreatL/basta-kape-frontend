...
import { createProductType } from '#/api/product-settings.ts';
...
interface CreateTypeFormValues {
    name: string;
    description?: string;
}

export default function TypeCreateDialog({ open, onOpenChange }: TypeCreateDialogProps) {
    ...
    const createMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            toast.success('Product Type Created', {
                description: 'The new product type has been successfully created.'
            });
            onOpenChange(false);
        },
        onError: (error) => {
            ...
            <DialogContent className="max-w-xl max-h-[85vh] flex flex-col p-0 overflow-hidden bg-background">
                <DialogHeader className="px-6 pt-6 pb-2">
                    ...
                    <DialogDescription className="text-xs">
                        Define a product classification (e.g. Hot Beverage, Iced Beverage, Baked Goods).
                    </DialogDescription>
                </DialogHeader>
