            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div className="bg-card border border-border/60 rounded-2xl p-5 shadow-2xs space-y-2">
                    ...
                    <div className="space-y-0.5">
                        ...
                        <span className="text-[10px] text-muted-foreground font-semibold">Before discounts apply</span>
                    </div>
                </div>
                ...
                <div className="bg-card border border-border/60 rounded-2xl p-5 shadow-2xs bg-gradient-to-br from-primary/5 to-transparent space-y-2">
                    ...
                    <div className="space-y-0.5">
                        ...
                        <span className="text-[10px] text-primary/80 font-bold">Total earnings in register</span>
                    </div>
                </div>
                ...
                <div className="bg-card border border-border/60 rounded-2xl p-5 shadow-2xs space-y-2">
                    <div className="flex justify-between items-center text-amber-600">
                        <span className="text-xs font-bold uppercase tracking-wider">Discounts Deducted</span>
                    ...
                    <div className="space-y-0.5">
                        ...
                        <span className="text-[10px] text-muted-foreground font-semibold">Senior Citizen & PWD discounts</span>
                    </div>
                </div>
                ...
                <div className="bg-card border border-border/60 rounded-2xl p-5 shadow-2xs space-y-2">
                    ...
                    <div className="space-y-0.5">
                        ...
                        <span className="text-[10px] text-muted-foreground font-semibold">Completed customer purchases</span>
                    </div>
                </div>
                ...
                <div className="bg-card border border-border/60 rounded-2xl p-5 shadow-2xs space-y-2">
                    ...
                    <div className="space-y-0.5">
                        ...
                        <span className="text-[10px] text-muted-foreground font-semibold">Average receipt ticket value</span>
                    </div>
                </div>
            </div>
                                    ...
                                    <div key={p.name} className="flex justify-between items-center">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[10px] text-muted-foreground font-semibold">{p.quantity} cups sold</span>
                                            </div>
                                        </div>
                                ...
                                <div className="flex flex-col gap-2 shrink-0">
                                    {orderTypeData.map((item, index) => (
                                        <div key={item.name} className="flex items-center gap-2">
                                            ...
                                            <div className="flex flex-col">
                                                <span className="text-[10px] font-extrabold text-foreground uppercase">{item.name}</span>
