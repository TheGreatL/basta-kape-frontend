            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <span className="text-sm font-bold text-foreground/90">
                        {row.original.quantity.toLocaleString()} {row.original.ingredient.defaultUnit.abbreviation}
                    </span>
                )
            },
            {
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <span className="text-xs text-muted-foreground font-medium">
                        {row.original.ingredient.reorderPoint.toLocaleString()} {row.original.ingredient.defaultUnit.abbreviation}
                    </span>
                )
            },
            {
